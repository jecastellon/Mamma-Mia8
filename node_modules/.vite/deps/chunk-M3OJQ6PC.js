...
// node_modules/@restart/ui/lib/Button.js
...
var Button2 = React2.forwardRef(({
  ...
  return (0, import_jsx_runtime2.jsx)(Component, {
    ...
    ref,
    disabled,
    className: clsx_default(className, prefix, active && "active", variant && `${prefix}-${variant}`, size && `${prefix}-${size}`, props.href && disabled && "disabled")
  });
});
...
//# sourceMappingURL=chunk-M3OJQ6PC.js.map
